...
var $author$project$Main$GotContainerElement = function (a) {
...
var $author$project$Main$init = function (_v0) {
	return _Utils_Tuple2(
		{classes: $elm$core$Dict$empty, containerHeight: 500, delay: 0, error: $elm$core$Maybe$Nothing, meosIp: '127.0.0.1:2009', results: _List_Nil, resultsHeight: 500, scrollSpeed: 50, showConfig: false, transformSpeed: 0},
		A2(
			$elm$core$Task$attempt,
			$author$project$Main$GotContainerElement,
			$elm$browser$Browser$Dom$getElement('container')));
};
var $author$project$Main$FetchResults = function (a) {
	return {$: 'FetchResults', a: a};
};
...
var $author$project$Main$subscriptions = function (model) {
	return $elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				A2($elm$time$Time$every, (2 * 60) * 1000, $author$project$Main$FetchResults)
			]));
};
var $author$project$Main$GotResultsElement = function (a) {
	return {$: 'GotResultsElement', a: a};
};
var $elm$core$Platform$Cmd$batch = _Platform_batch;
var $author$project$Main$CompleteClassesLoad = function (a) {
	return {$: 'CompleteClassesLoad', a: a};
};
...
var $author$project$Main$Class = F4(
	function (key, name, order, active) {
		return {active: active, key: key, name: name, order: order};
	});
...
var $ymtszw$elm_xml_decode$Xml$Decode$map4 = F5(
	function (toVal, dA, dB, dC, dD) {
		return $ymtszw$elm_xml_decode$Xml$Decode$Decoder(
			A5($ymtszw$elm_xml_decode$Xml$Decode$map4Impl, toVal, dA, dB, dC, dD));
	});
...
var $author$project$Main$xmlClassesDecoder = A2(
	...
	A2(
		...
		$elm$core$List$map(
			function (cls) {
				return _Utils_Tuple2(cls.key, cls);
			}),
		A5(
			$ymtszw$elm_xml_decode$Xml$Decode$map4,
			$elm$core$List$map4($author$project$Main$Class),
			A2(
				$ymtszw$elm_xml_decode$Xml$Decode$path,
				_List_fromArray(
					['cls']),
				$ymtszw$elm_xml_decode$Xml$Decode$list(
					$ymtszw$elm_xml_decode$Xml$Decode$intAttr('id'))),
			A2(
				$ymtszw$elm_xml_decode$Xml$Decode$path,
				_List_fromArray(
					['cls']),
			...
			A2(
				...
				_List_fromArray(
					['cls']),
				$ymtszw$elm_xml_decode$Xml$Decode$list(
					$ymtszw$elm_xml_decode$Xml$Decode$intAttr('ord'))),
			A2(
				$ymtszw$elm_xml_decode$Xml$Decode$path,
				_List_fromArray(
					['cls']),
				$ymtszw$elm_xml_decode$Xml$Decode$list(
					$ymtszw$elm_xml_decode$Xml$Decode$succeed(true))))));
var $author$project$Main$getClasses = function (meosIp) {
	return $elm$http$Http$get(
		{
			expect: A2($ymtszw$elm_http_xml$Http$Xml$expectXml, $author$project$Main$CompleteClassesLoad, $author$project$Main$xmlClassesDecoder),
			url: 'http://' + (meosIp + '/meos?get=class')
		});
};
var $author$project$Main$CompleteResultsLoad = function (a) {
	return {$: 'CompleteResultsLoad', a: a};
};
var $author$project$Main$ResultTime = F5(
	function (_class, status, time, name, team) {
		return {_class: _class, name: name, status: status, team: team, time: time};
	});
...
var $ymtszw$elm_xml_decode$Xml$Decode$map5 = F6(
	function (toVal, dA, dB, dC, dD, dE) {
		return $ymtszw$elm_xml_decode$Xml$Decode$Decoder(
			A6($ymtszw$elm_xml_decode$Xml$Decode$map5Impl, toVal, dA, dB, dC, dD, dE));
	});
...
var $author$project$Main$xmlSingleResultDecoder = A6(
	$ymtszw$elm_xml_decode$Xml$Decode$map5,
	$author$project$Main$ResultTime,
	$ymtszw$elm_xml_decode$Xml$Decode$intAttr('cls'),
	$ymtszw$elm_xml_decode$Xml$Decode$intAttr('stat'),
	A2(
		$ymtszw$elm_xml_decode$Xml$Decode$withDefault,
		-1,
		$ymtszw$elm_xml_decode$Xml$Decode$intAttr('rt')),
	A2(
		$ymtszw$elm_xml_decode$Xml$Decode$path,
		_List_fromArray(
			['name']),
	...
	A2(
		...
		_List_fromArray(
			['org']),
		$ymtszw$elm_xml_decode$Xml$Decode$single($ymtszw$elm_xml_decode$Xml$Decode$string)));
var $author$project$Main$xmlResultsDecoder = A2(
	$ymtszw$elm_xml_decode$Xml$Decode$path,
	_List_fromArray(
		['results', 'person']),
	$ymtszw$elm_xml_decode$Xml$Decode$list($author$project$Main$xmlSingleResultDecoder));
var $author$project$Main$getResults = function (meosIp) {
	return $elm$http$Http$get(
		{
			expect: A2($ymtszw$elm_http_xml$Http$Xml$expectXml, $author$project$Main$CompleteResultsLoad, $author$project$Main$xmlResultsDecoder),
			url: 'http://' + (meosIp + '/meos?get=result')
		});
};
var $elm$core$Platform$Cmd$none = $elm$core$Platform$Cmd$batch(_List_Nil);
var $author$project$Main$stringFromHttpError = function (err) {
	switch (err.$) {
		case 'BadBody':
			var msg = err.a;
			return 'Bad Body: ' + msg;
		...
		case 'BadStatus':
			var errNum = err.a;
			return 'Bad Status: ' + $elm$core$String$fromInt(errNum);
		default:
			var msg = err.a;
			return 'Bad Url: ' + msg;
	}
...
var $author$project$Main$updateModelScrollSpeed = F3(
	function (newHeight, speed, model) {
		var should_scroll = _Utils_cmp(newHeight, model.containerHeight * 2) > 0;
		var should_update_speed = ((!_Utils_eq(model.resultsHeight, newHeight)) || (!_Utils_eq(model.scrollSpeed, speed))) && should_scroll;
		var new_speed = newHeight / speed;
		return _Utils_update(
			model,
			{
				delay: (should_update_speed && (model.transformSpeed > 0)) ? (model.delay + (model.transformSpeed - new_speed)) : model.delay,
				resultsHeight: newHeight,
				scrollSpeed: speed,
				transformSpeed: should_update_speed ? new_speed : (should_scroll ? model.transformSpeed : 0)
			});
	});
	...
	function (msg, model) {
		switch (msg.$) {
			case 'FetchResults':
				return _Utils_Tuple2(
					model,
					$author$project$Main$getResults(model.meosIp));
			case 'GotContainerElement':
				if (msg.a.$ === 'Ok') {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{containerHeight: (element.viewport.height - element.element.y) - 10}),
						$author$project$Main$getClasses(model.meosIp));
				} else {
					var error = msg.a.a.a;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								error: $elm$core$Maybe$Just('Not Found element: ' + error)
							}),
						$author$project$Main$getClasses(model.meosIp));
				}
			case 'CompleteClassesLoad':
				if (msg.a.$ === 'Ok') {
					var newClasses = msg.a.a;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								classes: A2($elm$core$Dict$union, model.classes, newClasses)
							}),
						A2(
							$elm$core$Task$attempt,
							$author$project$Main$GotResultsElement,
							$elm$browser$Browser$Dom$getElement('results')));
				} else {
					var error = msg.a.a;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								error: $elm$core$Maybe$Just(
									'Error getting classes: ' + $author$project$Main$stringFromHttpError(error))
							}),
						A2(
							$elm$core$Task$attempt,
							$author$project$Main$GotResultsElement,
			...
			case 'CompleteResultsLoad':
				if (msg.a.$ === 'Ok') {
					var res = msg.a.a;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{error: $elm$core$Maybe$Nothing, results: res}),
						A2(
							$elm$core$Task$attempt,
							$author$project$Main$GotResultsElement,
							$elm$browser$Browser$Dom$getElement('results')));
					...
					return _Utils_Tuple2(
						_Utils_update(
							...
							{
								error: $elm$core$Maybe$Just(
									'Error getting results: ' + $author$project$Main$stringFromHttpError(error))
							}),
			...
			case 'SetScrollSpeed':
				...
				return _Utils_Tuple2(
					A3(
						$author$project$Main$updateModelScrollSpeed,
						model.resultsHeight,
						A2(
							$elm$core$Maybe$withDefault,
							0,
							$elm$core$String$toFloat(speedStr)),
						model),
					$elm$core$Platform$Cmd$none);
			case 'SetMeosIp':
				var meosIpStr = msg.a;
			...
			default:
				if (msg.a.$ === 'Ok') {
					var element = msg.a.a;
					return _Utils_Tuple2(
						A3($author$project$Main$updateModelScrollSpeed, element.element.height, model.scrollSpeed, model),
						$elm$core$Platform$Cmd$none);
				} else {
					var error = msg.a.a.a;
					return _Utils_Tuple2(
...
var $author$project$Main$SetClassActive = function (a) {
	return {$: 'SetClassActive', a: a};
};
var $author$project$Main$SetMeosIp = function (a) {
	return {$: 'SetMeosIp', a: a};
};
var $author$project$Main$SetScrollSpeed = function (a) {
	return {$: 'SetScrollSpeed', a: a};
};
var $author$project$Main$ToggleConfig = {$: 'ToggleConfig'};
var $author$project$Main$UpdateClick = {$: 'UpdateClick'};
...
var $author$project$Main$getActiveClassNames = function (classes) {
	return A2(
...
var $author$project$Main$timeView = function (time) {
	var secondStr = $elm$core$String$fromInt(
		A2($elm$core$Basics$modBy, 60, (time / 10) | 0));
	var second = ($elm$core$String$length(secondStr) === 1) ? ('0' + secondStr) : secondStr;
	var minuteStr = $elm$core$String$fromInt(
		A2($elm$core$Basics$modBy, 60, (((time / 10) | 0) / 60) | 0));
	var minute = ($elm$core$String$length(minuteStr) === 1) ? ('0' + minuteStr) : minuteStr;
	var hour = $elm$core$String$fromInt((((((time / 10) | 0) / 60) | 0) / 60) | 0);
	return hour + (':' + (minute + (':' + second)));
};
var $author$project$Main$singleResultView = function (res) {
	return A2(
		$elm$html$Html$li,
		_List_Nil,
		_List_fromArray(
			[
				$elm$html$Html$text(
				res.name + (' | ' + ((res.status === 1) ? $author$project$Main$timeView(res.time) : 'not finished')))
			]));
};
var $author$project$Main$keyedSingleResultView = function (res) {
	return _Utils_Tuple2(
		res.name,
		A2($elm$html$Html$Lazy$lazy, $author$project$Main$singleResultView, res));
};
...
var $author$project$Main$classResultView = F2(
	function (className, results) {
		return A2(
			$elm$html$Html$li,
			_List_fromArray(
				[
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$text(className)
						])),
					A2(
					$elm$html$Html$Keyed$ol,
					_List_fromArray(
						[
							$elm$html$Html$Attributes$class('class_results')
						]),
					A2($elm$core$List$map, $author$project$Main$keyedSingleResultView, results))
				]));
	});
var $elm$virtual_dom$VirtualDom$lazy2 = _VirtualDom_lazy2;
var $elm$html$Html$Lazy$lazy2 = $elm$virtual_dom$VirtualDom$lazy2;
var $author$project$Main$keyedClassResultView = F3(
	function (classId, className, results) {
		return _Utils_Tuple2(
			$elm$core$String$fromInt(classId),
			A3($elm$html$Html$Lazy$lazy2, $author$project$Main$classResultView, className, results));
	});
...
var $author$project$Main$resultListView = F2(
	function (classIds, model) {
		return A2(
			...
			A2(
				...
				function (cls) {
					return A3(
						$author$project$Main$keyedClassResultView,
						cls.key,
						cls.name,
						A2(
							$elm$core$List$filter,
							function (res) {
								return _Utils_eq(res._class, cls.key);
							},
							model.results));
				},
				A2(
					...
					$elm$core$Dict$values(
						A2(
							...
							F2(
								function (key, _v0) {
									return A2($elm$core$List$member, key, classIds);
								}),
							model.classes)))));
	});
var $author$project$Main$resultsView = function (model) {
	var classIds = $elm$core$Set$toList(
				...
				function (classId) {
					return A2(
						...
						A2(
							...
							A2($elm$core$Dict$get, classId, model.classes)));
				},
				A2(
					$elm$core$List$map,
					function (res) {
					...
					model.results))));
	return (_Utils_cmp(model.resultsHeight, model.containerHeight) > 0) ? _Utils_ap(
		_List_fromArray(
			[
				A2($author$project$Main$resultListView, classIds, model)
			]),
		_List_fromArray(
			[
				A2($author$project$Main$resultListView, classIds, model)
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text(
								$author$project$Main$getActiveClassNames(model.classes))
							])),
						A2(
						$elm$html$Html$button,
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$Main$ToggleConfig)
							]),
						_List_fromArray(
							[
				...
				_List_fromArray(
					[
						...
						'height',
						$elm$core$String$fromFloat(model.containerHeight) + 'px')
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								...
								$elm$html$Html$Attributes$style,
								'animation-duration',
								$elm$core$String$fromFloat(model.transformSpeed) + 's'),
								...
								_List_fromArray(
									[
										_Utils_Tuple2(
										'auto-scroll',
										_Utils_cmp(model.resultsHeight, model.containerHeight) > 0)
									]))
							]),
						$elm$core$List$isEmpty(model.results) ? _List_fromArray(
							[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								_Utils_Tuple2('config', true),
								_Utils_Tuple2('hide', !model.showConfig)
							]))
					]),
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$placeholder('pixel pr. sekund scroll'),
										$elm$html$Html$Attributes$type_('text'),
										$elm$html$Html$Attributes$id('speed'),
										$elm$html$Html$Events$onInput($author$project$Main$SetScrollSpeed),
										$elm$html$Html$Attributes$value(
										$elm$core$String$fromFloat(model.scrollSpeed))
									]),
								_List_Nil),
								A2(
								$elm$html$Html$input,
								_List_fromArray(
									[
										$elm$html$Html$Attributes$placeholder('meos ip og port'),
										$elm$html$Html$Attributes$type_('text'),
										$elm$html$Html$Attributes$id('meosIp'),
										$elm$html$Html$Events$onInput($author$project$Main$SetMeosIp),
										$elm$html$Html$Attributes$value(model.meosIp)
									]),
								_List_Nil),
								A2(
								$elm$html$Html$button,
								_List_fromArray(
									[
										$elm$html$Html$Events$onClick($author$project$Main$UpdateClick)
									]),
								_List_fromArray(
									[
										$elm$html$Html$text('opdater')
									]))
							])),
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('class-config')
							]),
						A2(
							$elm$core$List$map,
							function (cls) {
										...
										[
											...
											_List_fromArray(
												[
													...
													$elm$html$Html$Attributes$checked(cls.active),
													$elm$html$Html$Events$onCheck(
													function (chk) {
														return $author$project$Main$SetClassActive(
															_Utils_Tuple2(cls.key, chk));
													})
												]),
											_List_Nil),
											$elm$html$Html$text(cls.name)
										]));
							},
							A2(
								$elm$core$List$sortBy,
								...
								$elm$core$Dict$values(model.classes))))
					])),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
